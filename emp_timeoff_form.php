<?PHP
/******************************************************************************
**  File Name: emp_timeoff_form.php
**  Description: Form that is an include for emp_timeoff_compile.php
**  Displays a form with a week of vacation information to turn into HR.
...
<link rel="stylesheet" href="'.DIR_PATH.'css/site.css" type="text/css">
</head>
<body>
<table border="1" cellpadding="0" cellspacing="2" width="670" style="border-color:#000000" class="text10BkB">
  <tr>
    <td>
      <table border="1" cellspacing="2" width="100%" style="border-color:#000000">
          ...
          <td>&nbsp;
            ...
            <div align="center">
              <table border="0" cellpadding="0" cellspacing="0" width="90%">
                ...
                <tr>
                  <td width="50%" height="2"><img border="0" src="images/blk_line.gif" width="250" height="1"></td>
                  <td width="50%" height="2" align="center">
                    <img border="0" src="images/blk_line.gif" width="100" height="1"></td>
                </tr>
                <tr>
                  <td width="50%">Name</td>
                  <td width="50%" align="center">
			...
			$mark = "";
              ...
              <tr>
                <td width="220" align="center">
                  <img border="0" src="images/blk_line.gif" width="200" height="1"></td>
                <td width="150" align="center">
                  <img border="0" src="images/blk_line.gif" width="110" height="1"></td>
                <td width="25" align="center">
                  <img border="0" src="images/blk_line.gif" width="20" height="1"></td>
                <td width="250"><img border="0" src="images/spacer.gif"></td>
              </tr>
              <tr>
                <td width="220" height="30" align="center" valign="bottom">
                '.$personal.'</td>
        ...
        if($personal != ""){
			...
			$mark = "";
              ...
              <tr>
                ...
                <td width="150" align="center">
                  <img border="0" src="images/blk_line.gif" width="110" height="1"></td>
                <td width="25" align="center"><img border="0" src="images/blk_line.gif" width="20" height="1"></td>
                <td width="250"><img border="0" src="images/spacer.gif"></td>
              </tr>
              <tr>
                <td width="220" height="30" align="center" valign="bottom">
        ...
        if($safety != ""){
			...
			$mark = "";
              ...
              <tr>
                <td width="220" height="1" align="center"><img border="0" src="images/blk_line.gif" width="200" height="1"></td>
                <td width="150" height="1" align="center"><img border="0" src="images/blk_line.gif" width="110" height="1"></td>
                <td width="25" align="center" height="1"><img border="0" src="images/blk_line.gif" width="20" height="1"></td>
                <td width="250" height="1"><img border="0" src="images/spacer.gif"></td>
              </tr>
              </table>
            </div>
            <div align="center">
