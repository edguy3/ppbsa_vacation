...
$cur_page_title = "Vacation Report";
...
if(!$date_selection){
	...
	echo '<p><a href="report_weekly_entered_time.php">Select another group or time frame</a><br />
 ...
 echo '
 <form method="POST" action="report_weekly_entered_time_pf.php" target="_blank" name="printer">
 ...
 <form method="POST" action="report_weekly_entered_time_pdf.php" target="_blank" name="prtpdf">
	<input type="hidden" name="weeks_to_display" value="'.$weeks_to_display.'">
	<input type="hidden" name="sunday_choice" value="'.$selected_date.'"> 
	<input type="hidden" name="date_selection" value="'.$date_selection.'"> 
	<input type="hidden" name="dept_choice" value="'.$dept_choice.'"> 
